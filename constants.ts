...
const PlaceholderIcon: React.FC<{ className?: string }> = ({ className }) => React.createElement('div', { className: `w-5 h-5 ${className}` }, '🔊');
...
export const AMBIENT_SOUNDS: AmbientSound[] = [
    { id: 'rain', name: 'Rain', icon: React.createElement(PlaceholderIcon, null) },
    { id: 'forest', name: 'Forest Dojo', icon: React.createElement(PlaceholderIcon, null) },
    { id: 'library', name: 'Quiet Library', icon: React.createElement(PlaceholderIcon, null) },
];
